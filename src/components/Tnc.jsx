...
function Tnc() {
  ...
  return (
    <div>
      <div className="max-w-6xl text-lg mx-auto bg-white p-6 rounded-lg shadow-lg mt-6">
        <h1 className="text-4xl text-center font-bold text-pink-700 mb-4">
          Terms & Conditions
        </h1>

        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-2"></h2>
        <p className="text-gray-700">
          Welcome to
          <span className="font-bold text-gray-900"> Nikah Naama </span>. These
          <span className="font-bold text-gray-900">
            {" "}
            Terms and Conditions{" "}
          </span>
          govern your use of our website located at Nikaahnaama.com. By
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-2"></h2>
        <p className="text-gray-700"> To use our Site, you must:</p>
        ...
        <p className="text-gray-700">
          ...
          >
            <strong> anis300663@gmail.com </strong>
          </a>
        </p>
      </div>
    </div>
