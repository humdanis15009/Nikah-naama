  ...
  return (
    <>
      <div className="max-w-6xl mx-auto p-6 bg-white shadow-md rounded-lg">
        <h1 className="text-4xl font-bold my-6 text-center text-pink-700">
          Privacy Policy
        </h1>
        <p className="mb-4">
          At &ldquo;Nikah Naama&rdquo;, we are committed to protecting your
        ...
        <p className="mb-4">
          ...
          <ul className="list-disc list-inside ml-5">
            <li>
              ...
              experience on &ldquo;Nikah Naama&rdquo; and tailor content to your
              preferences.
            </li>
            <li>
        ...
        <h2 className="text-2xl font-semibold mb-3">4. Your Choices</h2>
        <p className="mb-4">
        ...
        <p>
          ...
          at{" "}
          <a
            href="mailto:support@nikahnaama.com"
            className="text-blue-500 hover:underline"
          >
            support@nikahnaama.com
          </a>
          .
        </p>
      </div>
