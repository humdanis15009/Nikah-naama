...
const Form2 = () => {
  ...
  useEffect(() => {
    if (selectedEmployedIn === "Other") {
      setEmployedIn(true);
      setValue("other-employedIn", ""); // Clear any previous value
    } else {
      setEmployedIn(false);
      setValue("other-employedIn", ""); // Clear the value if not 'Other'
    }
  ...
  return (
    <div className="min-h-[90vh] mt-12">
      <div className="max-w-5xl mx-auto p-6 bg-white shadow-2xl border-t-2 rounded-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label className="block text-lg pb-1 font-semibold">
              Currently living
            </label>
            <div className="flex gap-4">
              ...
              >
                ...
                {/* Ensure India is listed first
                 .filter((country) => country.isoCode !== "IN") */}
          ...
          <div className="flex py-2">
            <div className="text-lg font-semibold">
              Does Bride / Groom live with family?
            </div>
            <div
              className={`relative inline-flex items-center cursor-pointer ml-6 w-[90px] h-8 rounded-full transition-colors duration-300 ${
          ...
          <div className="flex gap-4">
            <div className="w-1/2">
              <label htmlFor="degree" className="block text-lg font-semibold">
                Highest Education
              </label>
              {degree ? (
                <input
                  ...
                  className=" mt-1 block w-full p-2 border border-gray-300 rounded-md  focus:ring-indigo-500"
                />
              ) : (
                <select
                  {...register("degree", {
                  ...
                  className="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focussmorder-indigo-500"
                >
          ...
          <div className="flex gap-4">
            <div className="w-1/2">
              <label className="block text-lg font-semibold">Employed In</label>
              {employedIn ? (
                <input
          ...
          <div className="flex gap-4">
            ...
            <div className="w-1/2">
              ...
              <select
                ...
                className="mt-1 block w-full py-2 px-3 border border-gray-300 rounded-md focus:ring-indigo-500"
              >
